  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-14 right-6 w-14 h-14 md:w-14 md:h-14 min-w-[56px] min-h-[56px] bg-koola-cyan rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(0,240,255,0.6)] hover:scale-110 transition-transform z-40"
      >
